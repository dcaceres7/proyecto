...
//void movimientos::inicializarTablero(){
//   for(int i=0;i<3;i++){
//        for(int j=0;j<3;j++){
//        tablero[i][j]=' ';
//        }
...
//}
//
//bool movimientos::cambiarTurno(int x, int y){
//
//    if(tablero[x][y]!=' ')
//        return false;
//
...
//}
//
//void movimientos::segundoCuadro(){
//        if(turno=='O'){
//            if(cambiarTurno(0,1)){
...
//}
//
//void movimientos::septimoCuadro(){
//        if(turno=='O'){
//            if(cambiarTurno(2,0)){
